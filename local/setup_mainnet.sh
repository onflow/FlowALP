...
# create pool
flow transactions send ./cadence/transactions/flow-alp/pool-factory/create_and_store_pool.cdc 'A.6b00ff876c299c61.MOET.Vault' --network mainnet --signer mainnet-deployer

# update oracle to BandOracle
flow transactions send ./cadence/transactions/flow-alp/pool-governance/update_oracle.cdc --network mainnet --signer mainnet-deployer
