...
/// PositionManager.borrowAuthorizedPosition and Position.setMaxHealth.
...
/// @param maxHealth: Maximum health factor before auto-repay is triggered
transaction(pid: UInt64, maxHealth: UFix64) {
