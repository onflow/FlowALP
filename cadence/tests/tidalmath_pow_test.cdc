...
fun test_pow_zero_exp_returns_one() {
    ...
    let out = TidalMath.powUFix128(base, 0.0)
...
fun test_pow_one_base_returns_one() {
    ...
    let out = TidalMath.powUFix128(1.0 as UFix128, 123.0)
    Test.assertEqual(1.0 as UFix128, out)
}
