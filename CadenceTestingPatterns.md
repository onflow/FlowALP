...
This document distills the patterns, idioms, and general "know-how" exhibited by the experienced Cadence developer who authored the current test-suite for **FlowALPv1**.  Use it as a practical checklist and style-guide when writing or reviewing Cadence tests.
