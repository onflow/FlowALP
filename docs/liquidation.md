# FlowALPv1 Liquidation Mechanism
...
FlowALPv1 uses a two-tier system to protect against insolvent positions:
...
A future update will add infrastructure for automatic liquidation via DEX (https://github.com/onflow/FlowALPv1/issues/97). Like automatic rebalancing, this will be implemented using scheduled transactions. 
